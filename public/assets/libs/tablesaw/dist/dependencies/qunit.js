...
(function (global$1) {
  ...
  var config = {
  	...
  	// The attachment module to use for reordering tests
  ...
  function done() {
  	...
  	// Clear own attachment items if all tests passed
  ...
  Test.prototype = {
  	...
  	queue: function queue() {
  		...
  		// Prioritize previously failed tests, detected from attachment
