                        ...
                        <div class="card-content">
                            ...
                            <form action="/dashboard/updateLecture/{{$editDetails->id}}" method="put" enctype="multipart/form-data" class="dropzone">
                                ...
                                <div class="Input-field">
                                    <input name="title1" value="{{$editDetails->title1}}" placeholder="Vide title">
                                </div>
                                <div class="Input-field">
                                    <input name="title2" value="{{$editDetails->title2}}"  placeholder="Subject name or chapter name">
                                </div>
                                <h5 class="card-title"><i class="ti-link"></i>Video</h5>
                                <div class="file-field input-field">
                                    <div class="btn">
                                        <span>Video</span>
                                        <input name="video" value="{{$editDetails->video}}"  type="file">
                                    </div>
                                    <div class="file-path-wrapper">
                                        <input name="videoName" value="{{$editDetails->videoName}}"  class="file-path validate" type="text" placeholder="attach video">
                                    </div>
                                </div>
                                <div class="Input-field m-t-20 m-b-20">
                                    <textarea name="description" id="mymce">{{$editDetails->description}}</textarea>
                                </div>
                                <h5 class="card-title"><i class="ti-link"></i> Attachment</h5>
                                <div class="file-field input-field">
                                    <div class="btn">
                                        <span>File</span>
                                        <input name="file" value="{{$editDetails->attachment1}}"  type="file">
                                    </div>
                                    <div class="file-path-wrapper">
